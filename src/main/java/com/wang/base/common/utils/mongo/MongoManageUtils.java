package com.wang.base.common.utils.mongo;
...
import com.wang.base.common.utils.SpringUtil;
...
public class MongoManageUtils {
    private static MongoTemplate imageMongoTemplate = SpringUtil.getBean( "imageMongoTemplate", MongoTemplate.class);

    private static GridFsTemplate imageGridFsTemplate = SpringUtil.getBean( "imageGridFsTemplate", GridFsTemplate.class);

    private static GridFSBucket imageGridFSBucket = SpringUtil.getBean("imageGridFSBucket", GridFSBucket.class);
    ...
    public static List<FileDocument> listFilesByPage(String collectionName, Integer pageIndex, Integer pageSize) {
        ...
        List<FileDocument> files = imageMongoTemplate.find(query , FileDocument.class , collectionName);
        return files;
    }
    ...
    public static Optional<FileDocument> getImageById(String id, String collectionName){
        Optional<FileDocument> fileDocumentOptional = getById(id,collectionName,imageMongoTemplate, imageGridFsTemplate, imageGridFSBucket);
    ...
    public static void removeImage(String id, String collectionName, Boolean isDeleteFile) {
        remove(id,collectionName,isDeleteFile,imageMongoTemplate, imageGridFsTemplate);
    }
     ...
     * @param isDeleteFile 是否删除文件
     */
    public static void removeFile(String id, String collectionName, Boolean isDeleteFile) {
     ...
     * @return
     */
    public static Optional<FileDocument> getFileById(String id, String collectionName){
